...
@Component({
  selector: 'app-voucherpayment',
  templateUrl: './voucherpayment.component.html',
  styleUrls: ['./voucherpayment.component.css']
})
export class VoucherPaymentComponent {
  ...
  transactionTypeGet() {
    ...
    this.transactionTypeService.transactionTypeGetById(4).subscribe(result => {
  ...
  voucherReceiptGetByTransactionTypeId() {
    this.service.voucherJournalGetByTransactionTypeId(4).subscribe(result => {
  ...
  totalReceiptCalculate() {
    this.totalReceipt = this.totalCreditReceipt - this.totalDifferenceReceipt;
  }
  ...
  totalCreditCalculate() {
    this.totalCreditReceipt = 0;
    this.voucherReceipt.journalVoucherDetails.forEach(e => {
      this.totalCreditReceipt += e.creditDefaultCurrency || 0;
    });
